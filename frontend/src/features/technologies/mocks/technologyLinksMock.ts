...
export const techLinksMock: TechnologyLinkType[] = [
  ...
  { name: TechnologyName.ESNEXT_ESM, url: 'https://www.typescriptlang.org/tsconfig#module' },
  { name: TechnologyName.AXIOS, url: 'https://axios-http.com/' },
  {
    name: TechnologyName.FETCH,
    url: 'https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API',
  },
  { name: TechnologyName.KAFKA, url: 'https://kafka.apache.org/' },
  ...
  { name: TechnologyName.VITEST, url: 'https://vitest.dev/' },
